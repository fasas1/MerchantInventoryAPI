...
namespace MechantInventory.Data
{
    public class ApplicationDbContext : IdentityDbContext<ApplicationUser>
    {
        ...
        public DbSet<ResellerTransactionItem> ResellerTransactionItems { get; set; }
        public DbSet<ResellerReturn> ResellerReturns { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<ResellerReturnItem>()
           .HasOne(rri => rri.ResellerReturn)
           .WithMany(r => r.Items)
           .HasForeignKey(rri => rri.ResellerReturnId)
           .OnDelete(DeleteBehavior.Cascade);

            //  Relationship: ResellerReturnItem → TransactionItem (NO cascade)
            modelBuilder.Entity<ResellerReturnItem>()
                .HasOne(rri => rri.ResellerTransactionItem)
                .WithMany(ti => ti.ReturnItems)
                .HasForeignKey(rri => rri.ResellerTransactionItemId)
